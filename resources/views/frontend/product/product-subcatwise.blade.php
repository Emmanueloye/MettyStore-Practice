...
@section('content')
@section('title')
MettyHair - {{$subcat->subcategory_name}}
@endsection
            ...
            <div class="tab-links">
                <div class="card">
                    <div class="card-heading">
                        ...
                        <span class="menu">{{$subcat->subcategory_name}}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane all-product show" id="tab-1">
                    <div class="tab-header">
                        <h2 class="heading">{{$subcat->subcategory_name}}</h2>
                    ...
                    <div class="row">
                        ...
                        @empty
                        <div class="error" style="margin: 40px auto;">
                            <p>Sorry, No product was found for this subcategory</p>
                        </div>
                        @endforelse
